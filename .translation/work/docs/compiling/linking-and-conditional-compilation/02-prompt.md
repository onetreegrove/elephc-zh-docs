...
Source path: docs/compiling/linking-and-conditional-compilation.md
Source file to read: .translation/work/docs/compiling/linking-and-conditional-compilation/source.md
Prompt artifact file: .translation/work/docs/compiling/linking-and-conditional-compilation/02-prompt.md
Final output file to write: .translation/work/docs/compiling/linking-and-conditional-compilation/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/compiling/linking-and-conditional-compilation/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/compiling/linking-and-conditional-compilation/translation.md, reply with a concise one-line status.