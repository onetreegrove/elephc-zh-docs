...
Source path: docs/compiling/output-and-diagnostics.md
Source file to read: .translation/work/docs/compiling/output-and-diagnostics/source.md
Prompt artifact file: .translation/work/docs/compiling/output-and-diagnostics/02-prompt.md
Final output file to write: .translation/work/docs/compiling/output-and-diagnostics/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/compiling/output-and-diagnostics/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/compiling/output-and-diagnostics/translation.md, reply with a concise one-line status.