...
Source path: docs/getting-started/your-first-program.md
Source file to read: .translation/work/docs/getting-started/your-first-program/source.md
Prompt artifact file: .translation/work/docs/getting-started/your-first-program/02-prompt.md
Final output file to write: .translation/work/docs/getting-started/your-first-program/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/getting-started/your-first-program/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/getting-started/your-first-program/translation.md, reply with a concise one-line status.