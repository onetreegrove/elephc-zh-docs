...
Source path: docs/how-to/fiber-web-server.md
Source file to read: .translation/work/docs/how-to/fiber-web-server/source.md
Prompt artifact file: .translation/work/docs/how-to/fiber-web-server/02-prompt.md
Final output file to write: .translation/work/docs/how-to/fiber-web-server/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/how-to/fiber-web-server/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/how-to/fiber-web-server/translation.md, reply with a concise one-line status.