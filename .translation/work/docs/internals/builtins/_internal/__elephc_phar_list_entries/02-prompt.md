...
Source path: docs/internals/builtins/_internal/__elephc_phar_list_entries.md
Source file to read: .translation/work/docs/internals/builtins/_internal/__elephc_phar_list_entries/source.md
Prompt artifact file: .translation/work/docs/internals/builtins/_internal/__elephc_phar_list_entries/02-prompt.md
Final output file to write: .translation/work/docs/internals/builtins/_internal/__elephc_phar_list_entries/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/internals/builtins/_internal/__elephc_phar_list_entries/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/internals/builtins/_internal/__elephc_phar_list_entries/translation.md, reply with a concise one-line status.