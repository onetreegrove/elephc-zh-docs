...
Source path: docs/internals/builtins/class/get_declared_classes.md
Source file to read: .translation/work/docs/internals/builtins/class/get_declared_classes/source.md
Prompt artifact file: .translation/work/docs/internals/builtins/class/get_declared_classes/02-prompt.md
Final output file to write: .translation/work/docs/internals/builtins/class/get_declared_classes/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/internals/builtins/class/get_declared_classes/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/internals/builtins/class/get_declared_classes/translation.md, reply with a concise one-line status.