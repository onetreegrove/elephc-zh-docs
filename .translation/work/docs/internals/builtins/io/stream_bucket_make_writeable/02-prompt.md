...
Source path: docs/internals/builtins/io/stream_bucket_make_writeable.md
Source file to read: .translation/work/docs/internals/builtins/io/stream_bucket_make_writeable/source.md
Prompt artifact file: .translation/work/docs/internals/builtins/io/stream_bucket_make_writeable/02-prompt.md
Final output file to write: .translation/work/docs/internals/builtins/io/stream_bucket_make_writeable/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/internals/builtins/io/stream_bucket_make_writeable/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/internals/builtins/io/stream_bucket_make_writeable/translation.md, reply with a concise one-line status.