...
Source path: docs/internals/builtins/misc/header.md
Source file to read: .translation/work/docs/internals/builtins/misc/header/source.md
Prompt artifact file: .translation/work/docs/internals/builtins/misc/header/02-prompt.md
Final output file to write: .translation/work/docs/internals/builtins/misc/header/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/internals/builtins/misc/header/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/internals/builtins/misc/header/translation.md, reply with a concise one-line status.
