---
title: "spl_autoload_call() — 内部实现"
description: "spl_autoload_call() 的编译器内部实现：lowering 路径、类型检查与运行时辅助函数。"
sidebar:
  order: 323
---

## `spl_autoload_call()` — 内部实现
...
- [`spl_autoload_call()` 用户参考](../../../php/builtins/spl/spl_autoload_call.md)
