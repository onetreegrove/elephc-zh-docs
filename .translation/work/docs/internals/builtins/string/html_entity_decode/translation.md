---
title: "html_entity_decode() — 内部实现"
description: "html_entity_decode() 的编译器内部实现：lowering 路径、类型检查与运行时辅助函数。"
sidebar:
  order: 359
---

## `html_entity_decode()` — 内部实现
...
- [`html_entity_decode()` 用户参考](../../../php/builtins/string/html_entity_decode.md)
