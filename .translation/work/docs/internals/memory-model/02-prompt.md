...
Source path: docs/internals/memory-model.md
Source file to read: .translation/work/docs/internals/memory-model/source.md
Prompt artifact file: .translation/work/docs/internals/memory-model/02-prompt.md
Final output file to write: .translation/work/docs/internals/memory-model/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/internals/memory-model/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/internals/memory-model/translation.md, reply with a concise one-line status.