...
Source path: docs/php/functions.md
Source file to read: .translation/work/docs/php/functions/source.md
Prompt artifact file: .translation/work/docs/php/functions/02-prompt.md
Final output file to write: .translation/work/docs/php/functions/translation.md
...
8. Write only the final translated Markdown to .translation/work/docs/php/functions/translation.md. Do not wrap it in commentary or a Markdown code fence.

After writing .translation/work/docs/php/functions/translation.md, reply with a concise one-line status.